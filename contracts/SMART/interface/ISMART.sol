...
/// - removed version(), since we don't use an IA
/// - added getRequiredClaimTopics() and getComplianceModules()
...
interface ISMART is IERC20, IERC20Metadata {
    ...
    /**
     * @dev Returns the required claim topics for this token
     * @return Array of required claim topics
     */
    function getRequiredClaimTopics() external view returns (uint256[] memory);

    /**
     * @dev Returns the compliance modules for this token
