...
// /// @title SMARTPausableToken
// /// @notice A basic SMART token implementation with core features only.

// contract SMARTPausableToken is SMART, SMARTPausable {
//     constructor(
//         string memory name_,
...
//      */
//     function _update(address from, address to, uint256 value) internal virtual override(SMART, SMARTPausable) {
