...
/// @title SMARTCollateralTokenWithAuthorization
/// @notice A basic SMART token implementation with core features only.

contract SMARTCollateralTokenWithAuthorization is
    SMART,
    SMARTCollateral,
    ...
    AccessControl
{
    ...
    function _beforeMint(address to, uint256 amount) internal virtual override(SMART, SMARTCollateral) {
