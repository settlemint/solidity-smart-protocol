...
contract MockAccessManager is IAccessManager {
    ...
    function getRoleGrantDelay(uint64) external pure returns (uint32) { return 0; }
    function getRoleGuardian(uint64) external pure returns (uint64) { return 0; }
    function getTargetFunctionRole(address, bytes4) external pure returns (uint64) { return 0; }
    function getTargetAdminDelay(address) external pure returns (uint32) { return 0; }
    ...
    function getSchedule(bytes32) external pure returns (uint48) { return 0; }
    function getNonce(bytes32) external pure returns (uint32) { return 0; }
    function schedule(address, bytes calldata, uint48) external returns (bytes32, uint32) { return (bytes32(0), 0); }
    function execute(address, bytes calldata) external payable returns (uint32) { return 0; }
    function cancel(address, address, bytes calldata) external returns (uint32) { return 0; }
    function consumeScheduledOp(address, bytes calldata) external {}
    function hashOperation(address, address, bytes calldata) external pure returns (bytes32) { return bytes32(0); }
    function updateAuthority(address, address) external {}
    function expiration() external pure returns (uint32) { return 0; }
    function getAccess(uint64, address) external pure returns (uint48, uint32, uint32, uint48) { return (0, 0, 0, 0); }
    function isTargetClosed(address) external pure returns (bool) { return false; }
    function labelRole(uint64, string calldata) external {}
    function minSetback() external pure returns (uint32) { return 0; }
}
...
contract SMARTCrossExtensionTest is Test {
    ...
    function testFuzz_CrossExtension_RandomOperationSequence(
        uint256 seed,
