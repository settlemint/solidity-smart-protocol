...
//         stableCoin =
//             _createStableCoin("StableCoin", "STBL", DECIMALS, new uint256[](0), new
// SMARTComplianceModuleParamPair[](0));
...
//         vm.startPrank(owner);
//         vm.expectRevert(abi.encodeWithSelector(InsufficientCollateral.selector, 100, 0)); // Assuming mint amount is
// 100
//         stableCoin.mint(user1, 100);
//         vm.stopPrank();
