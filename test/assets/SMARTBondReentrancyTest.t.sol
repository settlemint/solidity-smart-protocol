...
contract SMARTBondReentrancyTest is AbstractSMARTAssetTest {
    ...
    function test_MultipleRedemptionCallsProtected() public {
        ...
        assertEq(SMARTBondImplementation(address(bond)).bondRedeemed(user1), redeemAmount, "Should track redeemed amount");
    ...
    function test_RedeemInsufficientUnderlyingBalance() public {
        ...
        uint256 amountToRemove = currentBalance - (redeemAmount * faceValue / (10 ** DECIMALS)) + 1; // Leave just slightly less than needed
    ...
    function test_StateChangesAppliedBeforeExternalCall() public {
        ...
        assertEq(SMARTBondImplementation(address(bond)).bondRedeemed(user1), initialRedeemed + redeemAmount, "Redeemed amount not tracked correctly");
    ...
    function test_GasConsumptionWithReentrancyProtection() public {
        ...
        assertLt(gasUsed, 200000, "Gas consumption should be reasonable");
    }
