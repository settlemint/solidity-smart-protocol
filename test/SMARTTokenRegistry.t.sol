...
//         assertTrue(registry.hasRole(registry.REGISTRAR_ROLE(), user1), "user1 should have REGISTRAR_ROLE after
// grant");
//     }
...
//         // user1 (Registrar, not Admin) tries to revoke from user2 (who doesn't have it, but action should fail on
// auth)
//         vm.startPrank(user1);
//         vm.expectRevert(
//             abi.encodeWithSelector(AccessControlUnauthorizedAccount.selector, user1, registry.DEFAULT_ADMIN_ROLE())
