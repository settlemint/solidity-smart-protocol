...
import { InvalidSystemAddress, ETHTransfersNotAllowed, InitializationWithZeroAddress } from "../../contracts/system/SMARTSystemErrors.sol";
...
contract SMARTSystemProxyTest is Test {
    ...
    function test_FallbackFunctionDelegation() public {
        ...
        (bool success, bytes memory returnData) = address(proxy).call(
            abi.encodeWithSelector(MockImplementation.testFunction.selector)
        );
