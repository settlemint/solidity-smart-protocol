...
abstract contract SMARTTestBase is Test {
    ...
    function test_Transfer() public {
        ...
        assertEq(token.balanceOf(clientJP), 100, "Transfer BE->JP failed (JP balance)");
        assertEq(token.balanceOf(clientBE), 900, "Transfer BE->JP failed (BE balance)");
        ...
        assertEq(token.balanceOf(clientUS), 0, "Transfer BE->US should have failed (US balance)");
        assertEq(token.balanceOf(clientBE), 900, "Transfer BE->US should have failed (BE balance)");
        ...
        assertEq(
            token.balanceOf(clientUnverified), 0, "Transfer BE->Unverified should have failed (Unverified balance)"
        );
        assertEq(token.balanceOf(clientBE), 900, "Transfer BE->Unverified should have failed (BE balance)");
    }
